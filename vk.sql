...
CREATE TABLE `likes` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `likes` enum('0','1','2','3','4','5') DEFAULT '0',
  `to_user_id` int unsigned DEFAULT NULL,
  `post_id` int unsigned DEFAULT NULL,
  `media_id` int unsigned DEFAULT NULL,
  `from_user_id` int unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_likes_user1_idx` (`to_user_id`),
  KEY `fk_likes_post1_idx` (`post_id`),
  KEY `fk_likes_user2_idx` (`from_user_id`),
  ...
  CONSTRAINT `fk_likes_user1` FOREIGN KEY (`to_user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_likes_user2` FOREIGN KEY (`from_user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-26 23:07:59
